...
//		$parciales= "<td><SELECT NAME=\"PickList_".$this->get("relatedTable")."[]\" ID=\"PickList_".$this->get("relatedTable")."\" SIZE=\"5\" >";
		$parciales= "<td><SELECT NAME=\"".$this->get("relatedTable")."[]\" ID=\"PickList_".$this->get("relatedTable")."\" SIZE=\"5\" MULTIPLE >";
...
//		echo $cons;
		...
		$totales= "<td><SELECT NAME=\"SelectList_".$this->get("relatedTable")."\" ID=\"SelectList_".$this->get("relatedTable")."\" SIZE=\"5\" MULTIPLE >";
...
//		echo $consulta;
		...
		while($queryD = $this->parent->db->sql_fetchrow($qidD))
		{
			...
			$string .= "<input type=\"checkbox\" name=\"".$this->get("relatedTable")."[]\" value=\"".$queryD["id"]."\"".$ckecked.">".$queryD["nombre"]."<br>\n";
			$i++;
		}
