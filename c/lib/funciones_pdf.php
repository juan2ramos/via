...
class PDF extends FPDF{
	...
	function Header(){
		...
		$an = $this->areaUtil/count($this->titulos);

		$this->SetFont('Arial','B',12);
		$this->Cell($this->areaUtil,4,$this->reporte,0,1,"C");
		$this->setY($this->getY()+3);
		
		$borders = $widhts = $alignTitulo = $alignTablas = array();
		...
		$this->SetWidths($widhts);
		$this->SetAligns($alignTitulo);
		$this->SetFont('Arial','B',10);
		$this->Row($this->titulos);
		$this->SetFont('Arial','',8);
		$this->SetAligns($alignTablas);
	...
	function Footer(){
		...
		$this->Cell($this->areaUtil,4,'Página '.$this->PageNo().'/{nb}',0,1,"R");
