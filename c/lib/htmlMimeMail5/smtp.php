...
class smtp
{
    ...
    public function connect($params = array())
    {
        if (!isset($this->status)) {
            ...
            $greeting = $this->get_data();
						$this->remoteGreeting=trim($greeting);
    ...
    */
    public function send($params = array())
    {
        ...
        if ($this->is_connected()) {
            ...
            $result = (substr(trim($getData), 0, 3) === '250');
            //$this->rset();
						if(!$result) $this->errors[] = $getData;
            return $result;
        } else {
    ...
    */
    ...
    {
        if ($this->is_connected() AND $this->send_data('MAIL FROM:<'.$from.'>')) {
					$response=trim($this->get_data());
					if(substr($response, 0, 2) === '250' ) {
            return true;
					}
					else return false;
        } else {
