...
?>
      <div id="alineacion">
        ...
        <p><strong>País: </strong><?=$promotor["pais"]?><br />
  <strong>Website:</strong><a href="http://<?=$promotor["web"]?>"> <?=$promotor["web"]?></a><br />
          <strong>Áreas de interés:</strong> <?=$promotor["areas"]?>.<br />
          <strong>Actividades</strong>: <?=$promotor["actividades"]?>.<br />
          <strong>Idiomas</strong>: <?=$promotor["idiomas"]?>.</p>
