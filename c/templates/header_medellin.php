...
<title>Congreso Iberoamericano de Cultura <?if(isset($titulo)) echo ":: " . $titulo?></title>
<link href="../estilos.css" rel="stylesheet" type="text/css" />
<style type="text/css">
<!--
body {
	background-image: url(../imagenes/medellin_fondo.gif);
}
...
<div id="cabezote">
  <img src="../imagenes/cabezote_medellin.jpg" width="1000" height="100" border="0" usemap="#Menu" /> 
  ...
  <a href="feria.php">La Feria</a> | 
  <a href="rueda.php">Rueda de Negocios</a> | 
    ...
    <?
				if(!isset($_SESSION[$CFG->sesion]["user"]["id_nivel"])) echo "<input type=\"button\" onClick=\"window.location.href='login.php'\" value=\"".translate($arrTitulos,"entrar")."\">\n";
					...
					if($_SESSION[$CFG->sesion]["user"]["id_nivel"]==10){//Promotor
						...
						if(simple_me($ME)=="agenda.php" && (!isset($frm["mode"]))) $selected=" SELECTED";
						else $selected="";
						echo "<option value='agenda.php?id_mercado=" . $CFG->id_mercado_6 . "'$selected>".translate($arrTitulos,"miagenda")."</option>";
