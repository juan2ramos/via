    ...
    <body>
        ...
        <div class="title-iframe title ">
            <h2>Registro para profesionales</h2>
                ...
                <a class="" href="http://via.festivaldeteatro.com.co/m" target="_blank">REGISTRAME</a>
            <hr class="hr-iframe">
            <!--<h1>via</h1>-->
        </div>
...
<br>
              ...
              <p class="p-iframe"><br>
                ...
                <a href="https://www.facebook.com/pages/VIA-Ventana-Internacional-de-las-Artes-2012/105076839614385?fref=ts" target="_blank">VIA en Facebook</a>&nbsp; <br>
