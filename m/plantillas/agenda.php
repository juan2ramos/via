...
function detalle_mercado($frm){
	...
	if($mercado=$db->sql_fetchrow($qMercado)){
		...
		elseif($frm["mode"]=="agenda_promotor"){
			...
			$string.= "<div class='profesionales' style='height:180px; overflow:hidden'><p>" . $promotor["resena"] . "</p>\n";
			...
			$string.= "<div class='profesionales' style='height:180px; overflow:hidden'><p>" . $promotor["resena"] . "</p>\n";
			$string.= "<br><br><a class='vermas' style='margin-left:0;' href='http://2013.circulart.org/portafolios/portafolios-rueda-de-negocios/portafolios-perfiles-rueda-de-negocios.html?idioma=es&amp;banner=0&amp;num=' target='_blank'>Ver más</a>";
		}
		setlocale(LC_ALL,"es_ES@euro","es_ES","esp","es");
		$array["id"]=$mercado["id"];
		$array["string"]=$string;
