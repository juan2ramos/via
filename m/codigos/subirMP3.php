...
<tr>
<form action="uploaderMP3.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
<td>
...
<tr>
<td class="colorTexto">Recuerde que el archivo debe ser inferior de 5 Megas de peso, de formato [MP3] y que no tenga caracteres especiales como tides [&aacute;], dieresis [&uuml;], e&ntilde;e [&ntilde;&Ntilde;].</td>
</tr>
<tr>
  <td><div align="center" id="carga"><img src="loading31.gif" width="128" height="15"></div></td>
</tr>
