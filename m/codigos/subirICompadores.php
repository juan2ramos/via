...
<tr>
<form action="uploaderComp.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
<td>
...
<input type="hidden" name="id_programador" value="<?=$_GET["id_programador"];?>">
