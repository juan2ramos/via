  ...
  <form name="entryform" action="index.php?mercado=<?=$CFG->mercado?>" method="POST" enctype="multipart/form-data" onSubmit="return revisar(this)">
        ...
        <table width="1150px" border="0" cellspacing="0" cellpadding="7">
          ...
          <tr>
            ...
            <td colspan="2" rowspan="4" align="left" valign="top"><iframe src="codigos/imagen.php?item=<?=$frm["id_programador"]?>" width="100%" height="300px" frameborder="0" scrolling="yes"></iframe></td>
...
- E-mail 1</strong></td>
            ...
            <td rowspan="3" align="left" valign="top"><iframe src="codigos/subirHv.php?item=<?=$frm["id_programador"]?>" width="100%" height="160px;" frameborder="0" scrolling="no"></iframe></td>
          </tr>
          <tr>
          ...
          <tr>
			...
			if($db->sql_numrows($qEmpresas)>0){ 
			  ...
			  <table width="100%" cellpadding="5">
							<tr>
							<td colspan="2" rowspan="4"><iframe src="codigos/imagenLogo.php?item=<?=$empresa["id"]?>" width="100%" height="290px;" frameborder="0" scrolling="yes"></iframe></td>
