...
<table width="100%" border="1">
	...
	<tr><td align="right"><b>¿Fue pertinente el encuentro?:</b></td><td> Sí <input type="checkbox">&nbsp;&nbsp;&nbsp;No <input type="checkbox"></td></tr>
	<tr><td align="right"><b>¿Le gustaría recibir información via e-mail de este promotor?:</b></td><td> Sí <input type="checkbox">&nbsp;&nbsp;&nbsp;No <input type="checkbox"></td></tr>
