...
<table width="700" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="89" valign="middle"><img src="images/menu/ingles.gif" width="75" height="25" /></td>
    </tr>
</table>
</div>
  </div>
	<div id="contenido">
		...
		<? 
			...
			else if($frm["modo"]=="quienes" || $frm["modo"]=="preguntas" || $frm["modo"]=="enlaces"  || $frm["modo"]=="2011" ||  $frm["modo"]=="2010"  || $frm["modo"]=="redlat"  || $frm["modo"]=="equipo"  || $frm["modo"]=="contacto" || $frm["modo"]=="reglamento" || $frm["modo"]=="inscripciones" || $frm["modo"]=="curadores" || $frm["modo"]=="agenda") include("plantillas/informacion.php");
