...
//							echo $str_query;
	...
	//						$value=$value['nombre'];
						...
						if($this->parent->mode == "buscar" && $this->searchableRange){
							...
							$string.="<input type='text'" . $textInputClass . " size='" . $this->inputSize . "' ". $this->get("editable")." id='" . $this->field ."' name='" . $this->field ."$id' value='" . str_replace("'","&apos;",$this->value) . "' ". $onChange ." ".$readonly . ">";
					}
					break;
...
//							$relatedObjectValue=$this->parent->getAttributeByName($campo)->get("value");
				...
				case "arraySelectJoin":
					...
					break;	
				case "textarea":
					$string.="<textarea " . $inputStyle . " rows='" . $this->inputRows . "' cols='" . $this->inputSize . "' id='" . $this->field . "' name='" . $this->field . "$id' " . $this->get("editable") . ">" . $this->value . "</textarea>";
					break;
